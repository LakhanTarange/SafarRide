...
class AutoBookingPage extends StatefulWidget {
  ...
  @override
  State<AutoBookingPage> createState() => _AutoBookingPageState();
}

class _AutoBookingPageState extends State<AutoBookingPage> {
  ...
  Future<void> _confirmBooking() async {
    ...
    if (_hasPreselectedVehicle) {
      ...
      if (driverId == null || driverId.isEmpty) {
        _showMessage('This auto does not have an assigned driver.');
        return;
      }

      if (partnerId == null || partnerId.isEmpty) {
        _showMessage('This auto does not have an assigned owner.');
        return;
      }
    }
        ...
        builder: (dialogContext) {
          return AlertDialog(
            ...
            content: Column(
              ...
              children: [
                const Text('Your auto booking has been created successfully.'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Book an Auto')),
        ...
        child: Column(
          ...
          children: [
            if (_hasPreselectedVehicle && vehicle != null)
              _SelectedAutoCard(data: vehicle)
            else ...[
              const Text(
                'Auto Type',
              ...
              Wrap(
                ...
                children: [
                  ...
                  _AutoTypeChip(
                    label: 'Electric Auto',
                    selected: _autoType == 'Electric Auto',
                    onTap: () {
                      setState(() {
                        _autoType = 'Electric Auto';
                      });
                    },
                  ),
                  _AutoTypeChip(
                    label: 'Shared Auto',
                    selected: _autoType == 'Shared Auto',
                    onTap: () {
                      setState(() {
                        _autoType = 'Shared Auto';
                      });
                    },
                  ),
                ],
            ...
            SizedBox(
              ...
              child: FilledButton.icon(
                ...
                label: Text(_isBooking ? 'Booking...' : 'Confirm Auto Booking'),
              ),
            ),
...
class _SelectedAutoCard extends StatelessWidget {
  final Map<String, dynamic> data;

  const _SelectedAutoCard({required this.data});
  ...
  Widget build(BuildContext context) {
    ...
    final String type = data['vehicleType']?.toString() ?? 'Auto';
        ...
        children: [
          ...
          Row(
            children: [
              const CircleAvatar(
                radius: 28,
                child: Icon(Icons.local_taxi, size: 28),
              ),
...
class _AutoTypeChip extends StatelessWidget {
  final String label;
  final bool selected;
